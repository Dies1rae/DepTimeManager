        ...
        <main>
            ...
            <?php   
                ...
                for($i=0; $i< count($result_dep); $i++){
                    echo '<tr>';
                    echo '<td><form method = "POST" action="userpage.php"><input type="hidden" name="custId" value="'.$result_dep[$i]['account'].'"><input type="hidden" name="lname" value="'.$result_dep[$i]['name'].'" readonly="readonly"><input type="submit" value="'.$result_dep[$i]['name'].'"></form></td>';
                    echo '<td></td>';
                    echo '<td></td>';
                    echo '<td></td>';
                    echo '<td></td>';
